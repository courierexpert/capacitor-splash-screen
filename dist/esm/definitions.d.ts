import type { PluginResultError, PluginListenerHandle, WebPlugin } from '@capacitor/core';
/**
 ...
 */
export declare type SplashScreenDuration = number;
 ...
 */
export declare enum SplashScreenErrorType {
    /**
